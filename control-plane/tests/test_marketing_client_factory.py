...
def test_marketing_factory_returns_real_client_with_credentials(monkeypatch):
    # Case 3: In production/development, requesting a real channel with credentials returns the provider client
    monkeypatch.setenv("AOS_ENV", "production")
